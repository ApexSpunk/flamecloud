...
function Features() {
    return (
        <Box w='full' mt='138.36px' bg='#0566D4' py='115px'>
            <Box maxW='1192px' mx='auto'>
                ...
                <Grid templateColumns='repeat(4, 1fr)' columnGap='16.16px' rowGap='27px' mt='30px' maxW='1192px' mx={{ base: 'auto', md: 'auto', lg: 'auto' }} px={{ base: '16px', md: '16px', lg: '0' }}>
                    {
                        new Array(8).fill(0).map((_, index) => <GridItem key={index}  bg='rgba(255, 255, 255, 0.01)' border='1px solid rgba(255, 255, 255, 0.1)' borderRadius='5px' px='25px' py='22.5px' colSpan={{ base: '2', md: '2', lg: '1' }}>
